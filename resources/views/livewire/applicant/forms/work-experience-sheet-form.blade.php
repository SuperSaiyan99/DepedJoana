<div>
    <form wire:submit.prevent="save">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="position" name="position" placeholder="Enter position title" wire:model="position">
            @error('position') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="mb-4">
            <label for="officeUnit" class="form-label fw-bold">Name of Office/Unit</label>
            <input type="text" class="form-control" id="officeUnit" name="officeUnit" placeholder="Enter office or unit name" wire:model="officeUnit">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="supervisor" name="supervisor" placeholder="Enter supervisor name" wire:model="supervisor">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="agency" name="agency" placeholder="Enter agency or organization name" wire:model="agency">
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control" id="accomplishments" name="accomplishments" rows="3" placeholder="Enter accomplishments" wire:model="accomplishments"></textarea>
