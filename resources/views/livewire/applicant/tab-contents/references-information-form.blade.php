            ...
            <div class="repeater-item mb-3 border round p-3">
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="name-{{ $index }}" wire:model="references.{{ $index }}.name">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="address-{{ $index }}" wire:model="references.{{ $index }}.address">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="telNo-{{ $index }}" wire:model="references.{{ $index }}.telNo">
                        @error("references.{$index}.telNo") <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
                <button type="button" class="btn btn-danger mt-3" wire:click="removeReference({{ $index }})">Delete Entry</button>
            </div>
        @endforeach
        <div class="d-grid">
