    ...
    <script>
        ...
        if(! tourGuide) {
            ...
            const driverObj = driver({
                ...
                element: "#line-tab",
                steps: [
                    { element: '#line-tab', popover: { title: "Content Tabs", description: 'You can fill up your PDS here.', side: "top", align: 'center' }},
                    { element: '#line-others2-tab', popover: { title: 'Final Submition', description: 'If you\'re done, Just submit here.', side: "bottom", align: 'start' }}
                ],
