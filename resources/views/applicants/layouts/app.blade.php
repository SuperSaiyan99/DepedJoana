...
<head>
    ...
    <link rel="icon" href="{{ asset('assets3/img/kaiadmin/favicon.ico') }}" type="image/x-icon"/>
    ...
    <script>
        WebFont.load({
            ...
            custom: {
                ...
                urls: [
                    '{{ asset('assets3/css/fonts.min.css') }}'
                ]
            },
            active: function () {
...
<!-- Moment JS -->
<script src="{{ asset('assets3/js/plugin/moment/moment.min.js') }}"></script>
