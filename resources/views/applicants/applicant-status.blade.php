                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="p-3">
                                <h3 class="text-center">Unique Application Number #<strong><i>{{ 339 }}</i></strong>
                                </h3>
                                    ...
                                    <div class="bs-stepper-header" role="tablist">
                                        <div class="step active" data-target="#test-l-1">
                                            <button type="button" class="step-trigger" role="tab" id="stepper1trigger1"
                                                ...
                                                <span
                                                    class="bs-stepper-label d-none d-md-inline">Application Reviewed</span>
                                            </button>
                                        </div>
                                        ...
                                        <div class="step" data-target="#test-l-3">
                                            <button type="button" class="step-trigger" role="tab" id="stepper1trigger3"
                                                ...
                                                <span
                                                    class="bs-stepper-label d-none d-md-inline">Assessment Phase</span>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bs-stepper-content">
                                        <form>
                                            <div id="test-l-1" role="tabpanel"
                                                 class="bs-stepper-pane active dstepper-block"
                                                 aria-labelledby="stepper1trigger1">
                                                <div class="form-group">
                                                    <h4 class="text-center">Your process has been reviewed</h4>
                                                    <p class="text-center">If you have passed, you will receive further
                                                        instructions soon.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div id="test-l-3" role="tabpanel" class="bs-stepper-pane text-center"
                                                ...
                                                <button class="btn btn-primary mt-3" onclick="stepper1.previous()">
                                                    Previous
                                                </button>
